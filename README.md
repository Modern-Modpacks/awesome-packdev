...
- [Lockdown](https://legacy.curseforge.com/minecraft/mc-mods/lockdown) - Tool that allows you to package maps with your modpack as world as world presets. [![1.7+](icons/versions/plus/7.png)](## "Supports 1.7 and up")
